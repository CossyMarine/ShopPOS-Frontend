...
export default function ProductManagement() {
    ...
    const [receivingFor, setReceivingFor] = useState(null); // product being stocked
    const [stockForm, setStockForm] = useState(EMPTY_STOCK);
    const [receiving, setReceiving] = useState(false);
    const [labelFor, setLabelFor] = useState(null); // product to print a barcode label for
    ...
    // Earliest expiry across a product's batches — drives the "expiring soon" flag
                                        ...
                                        <div className="flex items-center gap-3 min-w-0">
                                            <div className="w-12 h-12 rounded-lg bg-gray-100 border border-gray-200 flex items-center justify-center shrink-0 overflow-hidden">
                                                {item.imageUrl ? (
                                                    ...
                                                    // Fallback: initials of the product name, no icon needed
